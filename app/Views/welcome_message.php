            ...
            <div class="login-form active" id="loginForm">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control with-icon" placeholder="Masukan User ID anda" required>
                    </div>

                    <!-- Password Field -->
                    <div class="form-group">
                        <i class="fas fa-lock input-icon"></i>
                        <input type="password" class="form-control with-icon" id="loginPassword" placeholder="Password" required>
                    </div>
